...
class SockClient {
  public static void main (final String args[]) {
    ...
    try { 
      ...
      System.out.println("What would you like to do (p) for permutation calculator, (pal) for palindrome check, type 'exit' to exit?");
      ...
      else if (choice.equals("pal")) {
        System.out.println("What is the String you want to check is a Palindrome?");
        //handles if no entry is input
        do{
        input = scanner.nextLine();
        }while(input.isEmpty());
      ...
      //Final output section
        ...
        if(choice.equals("perm")){
          System.out.println("Permutation is: " + response.getInt("data3"));
        }
        if(choice.equals("pal")){
          System.out.println("palindrome is: " + response.getString("data"));
        }
      }
